...
public class FlinkLookupFunction extends TableFunction<RowData> {
  ...
  private Object[] getKeys(Object keys) {
  ...
  private FlinkInputSplit[] getInputSplits(Object keys) {
